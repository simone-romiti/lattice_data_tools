...
# S = np.random.uniform(low=0.0, high=n_plaq, size=n_iter) # imagine you produced this data 
n = 3
...
log_t = get_log_t(n_live=50, n_iter=n_iter, sampling_t=False)
