...
def parametric_gaussian_bts(mean: float, std: float, N_bts: int, seed: int = 12345) -> np.ndarray:
    """Generate bootstrap samples from a Gaussian distribution
    ...
    Returns:
        np.ndarray: Bootstrap samples drawn from the Gaussian distribution
    """
