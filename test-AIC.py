...
# plt.plot(Pi[0], label="0")
# plt.plot(Pi[1], label="1")
# plt.plot(Pi[2], label="2")
# P = AIC.get_P(y=y, w=w, m=m, sigma=sigma, lam=1.0)
# plt.plot(P, label="tot")
# ####
# plt.legend()
# # print(P.shape)
...
print(sigma2_syst_exact, sigma2_syst)
print(sigma2_stat_exact, sigma2_stat)
